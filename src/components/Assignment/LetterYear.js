                        ...
                        <View style={styles.main}>
                            ...
                            <View>
                                ...
                                <View style={styles.div5}>
                                    <View style={{ flexDirection: "row" }}>
                                        <View style={ {margin:10}}>
                                            <Image style={{width:40, height:40}} source={require('../assets/img/goal.png')} />
                                        </View>
                                        <View>
                                ...
                                <View style={styles.div6}>
                                    <View style={{ flexDirection: "row" }}>
                                        <Image style={styles.imagseticon1} source={require('../assets/img/goal.png')} />
                                        <View>
                                ...
                                <View style={styles.div7}>
                                    <View style={{ flexDirection: "row" }}>
                                        <Image style={styles.imagseticon1} source={require('../assets/img/light.png')} />
                                        <View>
